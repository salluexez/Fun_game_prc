...
class _WingoContentState extends State<_WingoContent> {
  ...
  Widget _buildWalletCard(BuildContext context, WingoViewModel viewModel, WingoState state) {
    return Container(
  ...
  void _showMockWithdrawDialog(BuildContext context, WingoViewModel viewModel) {
  ...
  void _showMockDepositDialog(BuildContext context, WingoViewModel viewModel) {
